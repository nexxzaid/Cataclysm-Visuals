...
- Используйте инжектор на свой страх и риск.
- Обфускация может вызывать ложные срабатывания некоторых защит.
- Не модифицируйте скрипт без понимания последствий.
